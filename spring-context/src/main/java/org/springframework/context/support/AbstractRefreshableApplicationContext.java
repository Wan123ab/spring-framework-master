...
public abstract class AbstractRefreshableApplicationContext extends AbstractApplicationContext {
	...
	protected DefaultListableBeanFactory createBeanFactory() {
		...
		/**
		 * 使用内部父BeanFactory为当前容器上下文创建一个内部BeanFactory
		 * 内部父BeanFactory有2种情况：（即getInternalParentBeanFactory()返回值有2种情况）
		 * 1、如果当前context的父context是ConfigurableApplicationContext类型，那么返回父context的内部BeanFactory
		 * ps：ConfigurableApplicationContext接口有个方法getBeanFactory()
		 */
